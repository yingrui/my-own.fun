...
3. **需求**：无论是个人还是企业，都需要自有的AI解决方案能保护数据安全
4. **经验**：端侧AI Agent与具备问答能力的AI assistant相比，在提升生产力方面更有优势
5. **广泛适用性**：许多Web应用程序是基于旧系统构建的，通过浏览器扩展升级为带有AI能力的应用更具成本效益
6. **可行**：只要您有一台PC，就可以开始学习并构建智能应用
...
最后，代码是开源的，用户可以检查代码并构建自己的AI智能代理。

### 未来计划
我们计划在未来增加以下功能：
* 探索本地后端服务支持ChatPDF、RAG（检索增强生成）、基于知识基的问答等。
* 使用WebAssembly探索在浏览器中运行AI模型的可能性。
* AI智能代理：理解网页内容，并像一个人一样操作网页。

为了帮助软件工程师学习并构建智能应用，我们也在计划其他功能。

## 参与计划
gru.ai 是一个面向技术型应用程序软件开发工程师的开源项目，我们欢迎各种贡献。

### 对于前端工程师
* 等待您的贡献来支持Vue.js。

### 对于Firefox & Edge 粉丝
* 等待您的贡献来支持Firefox和Edge。